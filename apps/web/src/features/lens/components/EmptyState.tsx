...
export function EmptyState({
  ...
  return (
    <div className="rounded-xl border border-dashed border-border bg-card px-6 py-12 text-center shadow-[var(--shadow-card)]">
      ...
      <h2 className="mt-4 text-xl font-semibold text-foreground">No draft loaded yet</h2>
      <p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-muted-foreground">
        Choose a sample request to preload documents, route, receipt, and
        payload data for a safe draft review.
      </p>
